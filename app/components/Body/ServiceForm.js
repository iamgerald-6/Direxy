  ...
  return (
    <section className="flex justify-between">
      ...
      <div className="flex flex-col gap-5 font-sfRegular ">
        <input
          type="email"
          className=" ps-2 w-[30vw] bg-secondary-400 rounded-md py-2.5 text-primary-200 border-none outline-none"
        ...
        <div className=" flex gap-2 flex-wrap w-[40vw] ">
          <span className="px-2.5 py-1  text-sm rounded-full bg-secondary-400">
            L-Banners
          </span>
          <span className="px-2.5 py-1  text-sm rounded-full bg-secondary-400">
            LPMs
