  ...
  return (
    <section className="flex justify-between">
      ...
      <div className="flex flex-col gap-5 font-sfRegular ">
        <input
          type="email"
          className=" ps-2 w-[40vw] bg-secondary-400 rounded-md py-2.5 text-primary-200 border-none outline-none"
        ...
        <div className=" flex gap-3 flex-wrap w-[43vw] ">
          <span className="px-3 py-2  text-sm rounded-full bg-secondary-400">
            L-Banners
          </span>
          <span className="px-3 py-2  text-sm rounded-full bg-secondary-400">
            LPMs
        ...
        <div>
          <Button className="bg-primary-300 text-primary-100 px-7  font-sfBold mt-3">
            Submit your Idea
          </Button>
        </div>
      </div>
